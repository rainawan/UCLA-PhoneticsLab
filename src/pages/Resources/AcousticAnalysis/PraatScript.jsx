    ...
    <div>
      <div className="pt-10">
        ...
        <Accordion variant="shadow">
          ...
          <AccordionItem title="Analysis of Sounds Using Text Grids">
            <div className="pb-10 px-4">
              <Text p>
                <div className="pl-10">
                  <ul className="list-disc">
                    ...
                    <li>
                      ...
                      (Mietta Lennes)
                      <br />
                      Similar to the above script, but make file with startpoint
                      of each labeled interval.
                    </li>
                    <li>
                      <a
                      ...
                      <br />
                      Log midpoint F0-F3 and duration of vowels delimited by
                      labeled markers in a set of text grids {"("}KC's{" "}
                      <a
                        href="https://web.archive.org/web/20030620172734/ling.rochester.edu/people/cross/scripts.html"
                        className="text-blue hover:underline"
                        target="_blank"
                    ...
                    <li>
                      ...
                      (Mietta Lennes)
                      <br />
                      Log midpoint F1-F3 of text grid labeled intervals for a
                      set of Sound/TextGrid pairs.
                    </li>
                    <li>
                      <a
                      ...
                      (Mietta Lennes)
                      <br />
                      Reports and logs midpoint F1-F2 of vowels delimited by
                      labeled markers in a set of text grids.
                    </li>
                    <li>
                      <a
                      ...
                      , which gets pitch maxima and corresponding syllable
                      durations.
                    </li>
                    <li>
                      <a
                      ...
                      (Bert Remijsen)
                      <br />
                      Use the MOMEL (Hirst & Espesser) algorithm to log pitch
                      turning points to TextGrid.
                    </li>
                    <li>
                      <a
                      ...
                      (Chad Vicenik)
                      <br />
                      Makes various measurements, including H1-H2, H1-A1, H1-A2,
                      and H1-A3.
                    </li>
                  </ul>
                </div>
          ...
          <AccordionItem title="Segmentation and extraction">
            <div className="pb-10 px-4">
              <Text p>
                <div className="pl-10">
                  <ul className="list-disc">
                    <li>
                      ...
                      (Katherine Crosswhite)
                      <br />
                      Extract clips demarcated by labeled markers into
                      individual AIFF or WAV files {"("}KC's{" "}
                      <a
                    ...
                    <li>
                      ...
                      (Joe Toscano)
                      <br />
                      Take a WAV file and split it into smaller files
                      corresponding to utterances.
                    </li>
                    <li>
                      <a
                      ...
                      (Mietta Lennes)
                      <br />
                      Extract textgrid-demarcated clips from LongSound into
                      numbered files and log markers.
                    </li>
                    <li>
                      <a
                      ...
                      <br />
                      Extract textgrid-demarcated clips from LongSound into
                      files named after textgrid markers.
                    </li>
                    <li>
                      <a
                      ...
                      (John Tøndering)
                      <br />
                      Extract and concatenate voiced portions of selected Sound
                      to create new voiced-portions-only Sound.
                    </li>
                    <li>
                      <a
                      ...
                      (Mietta Lennes) From an open LongSound TextGrid, save
                      selected portion of LongSound and its TextGrid.
                    </li>
                    <li>
                      <a
          ...
          <AccordionItem title="Drawing pictures">
            <div className="pb-10 px-4">
              <Text p>
                <div className="pl-10">
                  <ul className="list-disc">
                    ...
                    <li>
                      ...
                      (Paul Boersma)
                      <br />
                      1998 dissertation including a number of sophisticated
                    ...
                    <li>
                      ...
                      (Mietta Lennes)
                      <br />
                      Draw a makeshift bar showing distribution of labeled
                      intervals from a file of timepoint, label pairs.
                    </li>
                    <li>
                      <a
                    ...
                    <li>
                      ...
                      (Chris Darwin)
                      <br />
                      Create a matrix of plots; format these plots by changing
                      the script code (try it with the defaults).
                    </li>
                  </ul>
                </div>
              </Text>
          ...
          <AccordionItem title="Noise and Speech Manipulation">
            <div className="pb-10 px-4">
              <Text p>
                <div className="pl-10">
                  <ul className="list-disc">
          ...
          <AccordionItem title="More Sound Analysis">
            <div className="pb-10 px-4">
              <Text p>
                <div className="pl-10">
                  <ul className="list-disc">
                  ...
                  <ul className="list-disc">
                    ...
                    <li>
                      ...
                      (John Tøndering)
                      <br />
                      Annotate a TextGrid with phonetic symbols using ManPage{" "}
                      {"("}see JT's{" "}
                      <a
          ...
          <AccordionItem title="Praat Scripts: Links and Online Collections">
            <div className="pb-10 px-4">
              <Text p>
                <div className="pl-10">
                  <ul className="list-disc">
