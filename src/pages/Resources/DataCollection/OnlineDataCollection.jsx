  ...
  return (
    <div>
      ...
      <p>
        ...
        . The Phonetics Lab has a group account of{" "}
        <Link
          isExternal
          href="https://www.labvanced.com/"
          underline="hover"
        ...
        Labvanced. To use other online platforms (Mechanical Turk or Prolific),
        please create an account in their respective website.
      </p>
      <p>&nbsp;</p>
    </div>
  );
